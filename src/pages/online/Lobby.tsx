  ...
  const seats: SeatInfo[] = seatIds.map((s) => {
    ...
    if (player) {
      ...
      return {
        seat: s,
        kind,
        occupant: { kind: "human", name: player.name, online: player.isOnline, avatarUrl },
        isHost: false,
