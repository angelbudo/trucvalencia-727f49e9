        ...
        <div className="fixed inset-x-0 bottom-0 animate-fade-in" style={{ zIndex: TRUC_Z_INDEX.chatDrawer }}>
          ...
          <div className="relative wood-surface border-t-2 border-primary/60 rounded-t-2xl pt-2 pb-4 px-3 max-h-[55vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span
                className="font-bold text-sm text-gold tracking-wide"
            ...
            <div className="grid grid-cols-2 gap-2">
              {activePhrases.map((p) => (
                <button
                  ...
                  className={cn(
                    "chat-phrase-btn px-3 py-3 rounded-xl border-2 text-sm transition-all active:scale-95 text-left",
                    TONE_STYLE[p.tone],
...
export function ChatBubble({
  ...
  const positionClass = {
    "top-left":    "top-full left-0 mt-3 rounded-tl-sm",
    "top-right":   "top-full right-0 mt-3 rounded-tr-sm",
