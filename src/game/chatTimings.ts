...
/** Answer delay used when both ends are bots. Alineat amb
 *  `CONSULT_ANSWER_DELAY_MS` perquè la cadència mínima missatge→resposta
 *  es complisca SEMPRE, també en xat entre bots. */
export const CONSULT_BOT_ANSWER_DELAY_MS = 1300;
...
export const FIRST_TRICK_OPENER_MIN_PLAY_MS = 7500;
